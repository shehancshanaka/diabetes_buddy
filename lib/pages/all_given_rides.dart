...
class AllGivenRideDetailsPage extends StatefulWidget {
  const AllGivenRideDetailsPage({
    Key? key,
  }) : super(key: key);

  @override
  _AllGivenRideDetailsPageState createState() =>
      _AllGivenRideDetailsPageState();
}

class _AllGivenRideDetailsPageState extends State<AllGivenRideDetailsPage> {
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        if (name != null &&
                          ...
                          if (action == 'update') {
                            // Update the product
                            await _giveride.doc(documentSnapshot!.id).update({
                              "name": name,
                              //"date": date,
                              //"time": time,
                              "gender": gender,
